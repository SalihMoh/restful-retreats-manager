...
import { Hotel, Star, Shield, Clock, Award, Users, Heart, ChevronRight, MapPin, CalendarDays } from "lucide-react";
...
const AboutPage = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Spécialiste du service client avec une approche centrée sur l'excellence et la satisfaction."
    }
  ];
  ...
  return (
    <div className="min-h-screen py-12 animate-fade-in">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Interactive Tab Navigation - Cool Feature 1 */}
        ...
        {activeTab === "about" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            {/* Animated Image Grid - Cool Feature 2 */}
        ...
        {activeTab === "team" && (
          <div>
            ...
            <p className="text-lg text-center text-muted-foreground max-w-3xl mx-auto mb-12">
              Découvrez les personnes passionnées qui travaillent chaque jour pour vous offrir la meilleure expérience de réservation d'hôtel.
            </p>
            
            {/* Interactive Team Cards - Cool Feature 3 */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                <div 
                  key={index} 
                  className="group relative bg-card overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all border border-border card-hover"
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-6 bg-gradient-to-t from-black/80 to-black/0 text-white">
                    ...
                    <p className="text-red-300 font-medium">{member.role}</p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                    <div className="p-6 text-white">
                      <h3 className="text-xl font-bold">{member.name}</h3>
                      <p className="text-red-300 font-medium mb-2">{member.role}</p>
        ...
        {/* Timeline Content - Cool Feature 4 */}
        {activeTab === "timeline" && (
          <div>
      ...
      {/* Statistics Section - Cool Feature 5 */}
